...
function Navbar() {
    ...
    <>
      <nav class="bg-transparent border-gray-200 text-white  ">
        ...
        <a class="flex items-center space-x-3 rtl:space-x-reverse">
          <Link to='/'>
            <img src={logo} class="h-[90px] container-fit p-2" alt="HalaHomes Logo" />
          </Link>
        </a>
          ...
          {isLoggedIn ?( <Link to='/Community'className='text-white'>
            Community
          </Link>):(
  ...
  <Link to='/log-in'>
  <button className='block md:border-2 border-white py-2 px-5 bg-white text-yellow-700 ml-6 rounded-full '>Login</button>
</Link>
)}
<div className={`md:hidden z-20 top-0 left-0 w-full ${dropdown && "bg-black bg-opacity-25 backdrop-blur-sm"} h-full fixed transition-all`}>
          <button
          ...
          {dropdown && (<div class="p-2 z-20 items-center justify-between fixed inset-y-10 start-0 w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul class="flex shadow-lg  flex-col gap-2 p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
              ...
              <li onClick={handleDropdownClick}>
               <a href='/About_us' class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 focus:bg-[#994b00]  focus:text-[#ffffff] md:p-0   " aria-current="page">About Us</a>
              </li>
              <li onClick={handleDropdownClick}>
              ...
              <li onClick={handleDropdownClick}>
             <a href='#value' class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 focus:bg-[#994b00]  focus:text-[#ffffff] md:p-0   ">Our Values</a>
              </li>
              <li onClick={handleDropdownClick}>
              <a href='#itworks' class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 focus:bg-[#994b00]  focus:text-[#ffffff] md:p-0   ">How it Works</a>
              </li>
              <li>
              {isLoggedIn ?( <Link to='/Community'className='text-white'><a class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 focus:bg-[#994b00]  focus:text-[#ffffff] md:p-0   ">Community</a></Link>)
              :(
                  <Link to='/log-in'className='text-white'><a class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 focus:bg-[#994b00]  focus:text-[#ffffff] md:p-0   ">Community</a></Link>
              )}
              </li>
            </ul>
          </div>)}
