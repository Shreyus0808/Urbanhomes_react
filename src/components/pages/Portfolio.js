...
export default function UserProfile_post() {
  ...
  return (
    ...
    {portfolio[0] ?(
      <>
    {portfolio.map((p) =>  (  
      <div className='md:flex w-[900px] text-left md:space-x-5 mt-4 shadow-lg rounded-lg overflow-hidden '>
        ...
        <img className='rounded-md h-[280px] w-full object-cover' src={`../uploads/${p.cover_img}`} alt='cover image' />
      ...
      <div className='relative p-2 w-1/2'>
        ...
        <img className='rounded-md object-cover w-full aspect-square'  src={`../uploads/${item.project_img}`} alt='project' />
