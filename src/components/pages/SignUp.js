                        ...
                        <form  className='p-0 border-0'onSubmit={handleFormSubmit} >
                            ...
                            <div className="col-lg-12 col-md-12 mb-4 col-sm-12">
                                    <div className="form-group grid grid-rows-2">
                                        ...
                                        <input required type="text" pattern="^\+[1-9]{1}[0-9]{1,14}$" title="Please enter a valid phone number of format along with country code." name="phone" id="phone" className="form-control" onChange={handleInputChange} value={formData.phone} placeholder="" />
                                    </div>
                                    </div>
                                </div>
