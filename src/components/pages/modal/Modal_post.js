      ...
      <div className='bg-white h-1/2 sm:w-[600px] sm:h-[450px] rounded-xl'>
        ...
        <div className='pt-10 pl-10 pr-10'>
          ...
          <div className='pt-8'>
              ...
              <textarea type='text' className='border resize-none rounded-md p-2 w-full h-28 shadow-lg' name='reason' value={formData.reason} onChange={handleInputChange} placeholder={`Type reason why you ${selectedOption === 'report' ? 'report comment' : 'block user'}`} />
            </div>
            <h1 className=''>
              <div className='pt-10 pl-96 '>
                ...
                <button type='submit' className='hover:border-slate-500 rounded-2xl shadow-lg hover:bg-yellow-700 h-8 w-16 text-slate-500 hover:text-white'>
                  Done
                </button>
              </div>
            </h1>
