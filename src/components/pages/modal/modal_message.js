  ...
  return (
    <div className='fixed top-0  w-full h-full flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm'>
        ...
        <h1 className='pt-5 font-bold text-xl'>Message:</h1>
                ...
                <div className='pt-2'>
                <div>
                    <textarea id="textBox" name="example"  className='resize-none border rounded-md p-2 w-full h-60 shadow-lg ' value={inputMessage}  placeholder={`Hi ${full_name}`}  onChange={(e) => setInputMessage(e.target.value)}/>
                ...
                <h1 className=''>
                    <div className='pt-10 pl-96 block '>
                        ...
                        <button className='hover:border-slate-500 rounded-2xl shadow-lg hover:bg-yellow-700 h-8 w-16 text-slate-500 hover:text-white' onClick={handleMessageSend} >Done</button>
