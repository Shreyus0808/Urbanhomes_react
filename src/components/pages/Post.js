               ...
               <div className=' w-3/5 flex space-y-10 flex-col'> 
                <div className='p-10 w-full  shadow-lg'>
                    <div className='flex space-x-4'>
                        <img src={`../uploads/${post.profile_pic}`} className='h-[50px] min-w-[50px] rounded-full object-cover '></img>
                        <div className='flex flex-col space-y-8'>
                            ...
                            <img className='h-60 w-80 object-cover' src={`../uploads/${post.media_url}`}></img>
                ...
                <tbody>
                    ...
                    <tr key={comment.id}>
                        ...
                        <img src={`../uploads/${comment.profile_pic}`} className='h-10 w-10 rounded-full object-cover '></img>
