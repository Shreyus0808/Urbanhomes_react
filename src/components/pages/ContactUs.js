...
const ContactUs = () => {
  return (
    ...
    <Navbar/>
    <div className='bg-white  w-full rounded-xl mt-14'>
        
  <h1 className="font-normal text-3xl md:text-4xl mb-4 md:flex md:items-center md:justify-center w-full tracking-wider">
            Contact {''}
            ...
            <ul class="mb-6 flex justify-between md:mb-0 mx-14 p-10">
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center rounded bg-yellow-700 text-gray-50">
        ...
        <form className='border-0 w-2/3 bg-transparent p-0 '>
