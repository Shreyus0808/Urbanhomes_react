...
import logo from '../images/hala_homes_white _.png'
    ...
    <>
      <nav class="bg-white shadow-xl  border-gray-200 text-gray-600">
        ...
        <a class="flex items-center space-x-3 rtl:space-x-reverse">
          <Link to='/'>
            <img src={logo} class="h-[90px] object-contain " alt="HalaHomes Logo"  />
          </Link>
        </a>
        <div className='hidden md:flex space-x-16'>
          ...
          >
            ...
            <div className='absolute mt-4 text-center divide-y-2 -translate-x-5 w-48 shadow-lg shadow-gray-800 bg-white flex flex-col z-10 '>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/builder' className='text-black hover:text-white hover:bg-[#994b00] transition-all  py-2'>
                Builders
               </Link>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/Designer' className='text-black py-2 hover:text-white hover:bg-[#994b00] transition-all '>
                Designer
               </Link>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/supplier' className='text-black py-2 hover:text-white hover:bg-[#994b00] transition-all '>
                Supplier
               </Link>
            </div>)}
          </div>
